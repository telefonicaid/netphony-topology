...
public class TopologyServerIETF extends TopologyServer
{
	...
	public TopologyServerIETF(TopologiesDataBase ted, TopologyModuleParams params,
			Lock lock) 
	{
